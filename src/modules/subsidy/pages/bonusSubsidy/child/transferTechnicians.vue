  ...
  <div>
    <el-row class="warp" style="background: #f8f8f8;" show-summary>
      <el-col style="background:#fff;border-radius:4px;padding-top:15px">
        <el-table ref="multipleTable" id="multipleTable" :summary-method="getSummaries" show-summary tooltip-effect="dark" :data="form" border style="width:95%;position:relative;left:2%;">
          ...
          <el-table-column prop="jobName" label="岗位" min-width="50"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    toExcel() {
      let tableObj = document.getElementById("multipleTable");
      tableToExcel(tableObj, "专技人员明细表.xlsx");
    },
  },
  filters: {},
};
