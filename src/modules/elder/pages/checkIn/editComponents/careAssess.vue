<template>
  <el-row class="care-assess" style="padding:20px;">
    ...
    <el-col :span="24">   
      <el-form>
        <AssessProject ref='AssessProject' @careAssess='careAssess' :sign="sign"></AssessProject>
      </el-form>
    </el-col>    
  </el-row>
</template>
...
<script>
  ...
  import moment from 'moment'
	export default {
		components: {AssessProject},
		props: ["elderId","elderName"],
		data() {
			return {
        sign: "add",
        form: {},
    ...
    created(){
      ...
      let endDate = moment(start).add(1, "y").subtract(1, "days").format('YYYY-MM-DD');
