	...
	export default {
		...
		data() {
			return {
                ...
                bigCategory: ["自理","自理","自理","自理","自理","自理","括约肌控制","括约肌控制",
                "转移","转移","转移","行进","行进","交流","交流","社会认知","社会认知","社会认知"],
		...
		methods:{
            ...
            saveAssemble(){
                let evaluationForm = [];
                let array = [this.judgeA1,this.judgeA2,this.judgeA3,this.judgeA4,this.judgeA5,
                            this.judgeA6,this.judgeB1,this.judgeB2,this.judgeC1,this.judgeC2,
                            this.judgeC3,this.judgeD1,this.judgeD2,this.judgeE1,this.judgeE2,
                            this.judgeF1,this.judgeF2,this.judgeF3];
        ...
        computed:{
            judgeAsum(){
                return this.judgeA1 + this.judgeA2 + this.judgeA3 + this.judgeA4 + this.judgeA5 + this.judgeA6;
            },
            judgeBsum(){
