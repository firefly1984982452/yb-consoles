<template>
  <div>
        ...
        <el-main>
          <div class="content">
            ...
            <el-table :data="listData" border>
              <el-table-column prop="name" label="项目内容" min-width="80"></el-table-column>
    ...
    <el-dialog title="项目" :visible.sync="dialogTemplateFormVisible" v-if="dialogTemplateFormVisible" :close-on-click-modal="false" width="650px" :append-to-body="true">
  ...
  methods: {
    ...
    fetchData() {
      ...
      axios
        .fetch(
          "medicalServer",
          "/api/category/page/" + this.category.type + "/" + this.parent.id,
          this.searchData,
          "form",
          "get"
        )
