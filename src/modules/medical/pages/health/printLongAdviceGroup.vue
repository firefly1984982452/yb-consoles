    ...
    <div id="printArea" ref="printArea" style="height:500px;width:100%;overflow:auto;">
      <table style="width:calc(100% - 1px);">
        <colgroup>
          ...
          <col name="el-table_1_column_2" width="45">
          <col name="el-table_1_column_3" width="45">
          <col name="el-table_1_column_4" width="300">
          <col name="el-table_1_column_6" width="60">
          <col name="el-table_1_column_7" width="45">
          <col name="el-table_1_column_8" width="45">
        </colgroup>
