    ...
    <el-dialog title="病程录" :visible.sync="dialogFormVisible" v-if="dialogFormVisible" :close-on-click-modal="false" width="800px">
      ...
      <el-form :model="form" :rules="rules" ref="ruleForm" label-width="80px" style="min-hei">
        <el-row v-if="form.type==1">
          ...
          <el-col :span="8">
            <el-form-item label="T">
              <el-input v-model="form.temperature" clearable oninput="value=value.replace(/(\d*\.\d).*/g,'$1')" placeholder="体温">
          ...
          <el-col :span="8">
            <el-form-item label="P">
              <el-input v-model="form.pulseRate" clearable oninput="value=value.replace(/[^\d]/g,'')" placeholder="脉搏">
        ...
        <el-row v-if="form.type==1">
          <el-col :span="8">
            <el-form-item label="R">
              <el-input v-model="form.respirationRate" clearable oninput="value=value.replace(/[^\d]/g,'')" placeholder="呼吸率">
                <template slot="append">次/分</template>
              </el-input>
            </el-form-item>
          </el-col>
        ...
        <el-row v-if="form.type==1">
          <el-col :span="8">
            <el-form-item label="空腹血糖">
              <el-input v-model.trim="form.bloodglucose" placeholder="" oninput="value=value.replace(/(\d*\.\d*).*/g,'$1')">
        ...
        <el-row v-if="form.type==1">
          ...
          <el-col :span="16" class="right" style="margin-bottom:8px;">
        ...
        <el-form-item label="其它描述" prop="detail" v-if="form.type==1">
          <el-input type="textarea" rows="5" v-model.trim="form.detail" maxlength="500" show-word-limit></el-input>
        </el-form-item>
...
export default {
  ...
  computed: {
    canEditDocument: function () {
      ...
      return !this.document.printTime;
    },
  },
  watch: {
    elder: "init",
  ...
  methods: {
    ...
    add() {
      this.form = { content: "", detail: "", type: 1 };
      this.template = {};
